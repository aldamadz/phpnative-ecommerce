    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    <a href="../adminpanel/kategori.php" class="no-decoration text-muted"> Kategori </a>
                </li>
            </ol>
        </nav>
        ...
        <div class="my-5 col-12 col-md-6">
            ...
            <form action="" method="post">
                <div>
                    ...
                    <input type="text" id="kategori" name="kategori" placeholder="Input nama kategori" class="form-control"></input>
                </div>
                <div class="mt-2">
